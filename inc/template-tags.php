...
if ( ! function_exists( 'bootstrap_base_4_1_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function bootstrap_base_4_1_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'bootstrap-base-4-1' ),
...
if ( ! function_exists( 'bootstrap_base_4_1_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function bootstrap_base_4_1_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'bootstrap-base-4-1' ),
...
if ( ! function_exists( 'bootstrap_base_4_1_entry_footer' ) ) :
	 ...
	 */
	function bootstrap_base_4_1_entry_footer() {
		// Hide category and tag text for pages.
		if ( 'post' === get_post_type() ) {
			/* translators: used between list items, there is a space after the comma */
			$categories_list = get_the_category_list( esc_html__( ', ', 'bootstrap-base-4-1' ) );
			if ( $categories_list ) {
...
if ( ! function_exists( 'bootstrap_base_4_1_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function bootstrap_base_4_1_post_thumbnail() {
